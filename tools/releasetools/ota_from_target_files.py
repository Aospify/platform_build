...
""" % bcb_dev)
  ...
  build_date = target_info.GetBuildProp("org.aospify.build_date")
  security_patch = target_info.GetBuildProp("ro.build.version.security_patch")
  device = target_info.GetBuildProp("org.aospify.device")

  script.Print("----------------------------------------------");
  script.Print("                    Aospify");
  script.Print("                   Pure AOSP");
  script.Print("                 by SlimShadys");
  script.Print("----------------------------------------------");
...
""" % bcb_dev)
  ...
  prev_build_date = source_info.GetBuildProp("org.aospify.build_date")
  build_date = target_info.GetBuildProp("org.aospify.build_date")
...
def WriteIncrementalOTAPackage(target_zip, source_zip, output_file):
  ...
  source_version_prop = "org.aospify.version.display"
